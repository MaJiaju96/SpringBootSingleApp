...
import com.xiaoma.moudle.webService.support.StrSpliter;
...
public class StringUtil extends StringUtils {
    ...
    public static List<String> split(CharSequence str, char separator, int limit, boolean isTrim, boolean ignoreEmpty) {
        return (null == str ? new ArrayList(0) : StrSpliter.split(str.toString(), separator, limit, isTrim, ignoreEmpty));
    }
     ...
     * @return
     */
    public static String splicingFilePath(String url , String filePath , String savePath) {
        if (StringUtil.isNotBlank(url)){
            return url;
        }
        filePath = filePath.startsWith(StringPool.SLASH) ? filePath : StringPool.SLASH + filePath;
        savePath = savePath.startsWith(StringPool.SLASH) ? savePath : StringPool.SLASH + savePath;
