...
public final class DateUtil {
    ...
    public static final String _PATTERN_DATE = "yyyy/MM/dd";
    ...
    public static Date formatDate(String dateStr) {
        return parse(dateStr, _PATTERN_DATE);
    }
    ...
    public static int numberOfDays(Date startDate, Date endDate) {
        if (startDate == null || endDate == null)
            throw new IllegalArgumentException("startDate or endDate is empty! please check params");
        if (endDate.before(startDate))
            throw new IllegalArgumentException("endDate may be startDate after!");
        Instant instant = startDate.toInstant();
        ZoneId zoneId = ZoneId.systemDefault();
        LocalDate startLocalDate = instant.atZone(zoneId).toLocalDate();
        Instant dateInstant = endDate.toInstant();
        LocalDate endLocalDate = dateInstant.atZone(zoneId).toLocalDate();
        return Math.toIntExact(ChronoUnit.DAYS.between((Temporal) startDate, (Temporal) endDate));
